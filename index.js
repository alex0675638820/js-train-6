...
// return `Key: ${country}, Value: ${country.Value}`
...
//   array.role = newRole;
return `"name:", ${array.name}, "role:", ${newRole}`;
  }
...
Array.prototype.myProperty = customProperty
...
// Створимо масив newArr з новою властивістю за допомогої нашої функції в яку передамо [1, 2, 3, 4, 5]
 ...
 newArr.customProperty;
// Розкоментуйте рядок нижче після виконня завдання для перевірки

console.log(newArr.customProperty); // Виведе myProperty
/// не зрозумів чому не виводиться. Якщо ставлю ()видає помилку.